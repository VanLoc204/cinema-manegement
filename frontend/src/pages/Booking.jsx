...
    const [seats, setSeats] = useState([]); // Chuyển thành mảng Object: [{id, price, type},...]
...
    // 💰 1. LẤY GIÁ PHÒNG & TÍNH TIỀN VÉ (Dựa trên từng loại ghế trong SeatMap)
...
                showtimeId: id,
                userId: userId,
                seats: seats.map(s => s.id), // Chỉ gửi ID ghế lên Backend
                snacks: snackList,
...
    // --- 🧾 GIAO DIỆN HÓA ĐƠN XỊN (ĐÃ NÂNG CẤP CHI TIẾT) ---
    if (bill) return (
...
                {/* Phần chi tiết bắp nước trong hóa đơn */}
...
                    <p>Cảm ơn sếp đã ủng hộ Cinema Lux!</p>
                    <p>Vui lòng xuất trình mã vé này tại quầy để nhận vé giấy.</p>
                </div>
...
                        {/* 📝 Truyền roomPrice vào SeatMap */}
                        <SeatMap onSelect={setSeats} showtimeId={id} roomPrice={roomPrice} />
                    </div>
                ) : (
                    <div>
